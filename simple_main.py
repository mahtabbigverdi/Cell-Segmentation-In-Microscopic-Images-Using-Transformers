...
class ClassificationLoss(nn.Module):
    ...
    def __init__(self, class_weights=torch.tensor([0.5, 1.5, 3], dtype=torch.float)) -> None:
        """
        Constructor method
        """
        # Call super constructor
...
class InstanceSegmentationLoss(nn.Module):
    ...
    def __init__(self, classification_loss: nn.Module = ClassificationLoss(),
                 ...
                 w_classification: float = 1.0, w_bounding_box: float = 1.0, w_segmentation: float = 3.0,
